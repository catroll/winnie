...
与 `01agent-langchain` 的差异：01 演示 Tools + Agent Loop；本例演示**跨轮上下文**与**收尾沉淀**，无工具。

## 运行

```bash
cd playground/02multi-turn-summary
cp .env.example .env   # 或复用 ../01agent-langchain/.env
uv sync
